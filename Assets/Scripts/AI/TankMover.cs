...
public class TankMover : MonoBehaviour
{
    ...
    private void Awake()
    {
        rbd = GetComponentInParent<Rigidbody>();
    }
    ...
    {
        rbd.velocity = (Vector3)transform.up * currentSpeed * currentForewardDirection * Time.fixedDeltaTime;
        rbd.MoveRotation(transform.rotation * Quaternion.Euler(0, 0, -movementVector.x * movementData.rotationSpeed * Time.fixedDeltaTime));
    }
}
